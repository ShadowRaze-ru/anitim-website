...
const CATEGORIES = [
  ...
  { id: 'workers', name: 'Рабочие', icon: 'bi bi-hammer', color: '#e67e00', keywords: /сварщик|токарь|фрезер|слесарь|оператор\s+(станк|чпу|цпу|лазер|плазм|гибоч)|наладчик|штамповщик|кузнец|шлифовщик|термист|гальваник|маляр|сборщик|монтажник|электрик|электромонтаж|механик|ремонтник|котельщик|жестянщик|стропальщик|крановщик|такелажник|рабочий|аппаратчик|вальцовщик|заточник|зуборезчик|карусельщик|расточник|долбежник|протяжчик|резьбонарез/i },
